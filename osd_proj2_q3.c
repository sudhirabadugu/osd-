...
int  time=0;
int rear_wait=-1;
int free_memory=8*1024*1024;
static unsigned char our_memory[1024 * 1024*8]; //reserve 8 MB for malloc
...
int main()
{
	...
	printf("\n Asuming  that the entire memory required is 10 MB \n ");
	printf("\n The memory block avaialable for management is 8MB \n");
